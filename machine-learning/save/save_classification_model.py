# -*- coding: utf-8 -*-
"""
Created on Mon May  4 19:56:40 2020
...
import pickle
pickle.dump(classificadorSVM, open('modelo_treinado/svm_finalizado.sav', 'wb'))
pickle.dump(classificadorRandomForest, open('modelo_treinado/random_forest_finalizado.sav','wb'))
pickle.dump(classificadorMLP, open('modelo_treinado/mlp_finalizado.sav', 'wb'))
